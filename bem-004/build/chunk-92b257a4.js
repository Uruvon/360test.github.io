import { w as writeTask } from './chunk-431e4868.js';
...
const iosTransitionAnimation = () => __sc_import_tender_viewer('./ios.transition-e115fe4c.js');
const mdTransitionAnimation = () => __sc_import_tender_viewer('./md.transition-7a03ebcf.js');
...
async function animation(animationBuilder, opts) {
    ...
    const trans = await __sc_import_tender_viewer('./index-d072b193.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
