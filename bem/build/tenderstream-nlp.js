...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "TenderstreamNlp","tenderstream-nlp",0,"tenderstream-nlp.core.js","es5-build-disabled.js","hydrated","ion-app,ion-card,ion-card-content,ion-card-header,ion-card-title,ion-content,ion-icon,ion-item,ion-label,ion-list,ion-note,ion-ripple-effect,ion-textarea,nlp-app",HTMLElement.prototype);